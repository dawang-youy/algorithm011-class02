毕业总结
  ...
  经过十周时间的学习，对数据结构和算法有了整体性的掌握，在此感谢老师不厌其烦的强调学习要点--总结、过遍数，编程思想、技巧，这里面对我来说最难的是刻意练习-练习缺陷、弱点的地方，之前养成的学习习惯，习惯于理解可以理解、规避不容易学习的，以后要克服不舒服、枯燥的感觉、养成良好的学习习惯、保持清醒的头脑是最关键的。那么在实际开发中，如何权衡选择使用哪种数据结构和算法？关于这个问题，参考了前人的总结有下面几条经验：

  1. 时间、空间复杂度不能跟性能划等号

    之前一直不明白时间复杂度与性能之间的关系，在学习每种数据结构和算法的时候，都详细分析了算法的时间复杂度、空间复杂度，但是，在实际的软件开发中，复杂度不能与性能简单划等号，不能表示执行时间和内存消耗的确切数据量。为什么这么说呢？原因有下面几点。
  ...
  学习数据结构和算法，我也是抱着解决实际问题的目的，不想停留在理论上，只为了应付面试。
